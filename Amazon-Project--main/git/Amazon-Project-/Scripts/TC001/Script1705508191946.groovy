...
WebUI.setText(findTestObject('Object Repository/Page_Amazon Sign In/input_email'), '9347196735')

WebUI.click(findTestObject('Object Repository/Page_Amazon Sign In/inputcontinue'))

WebUI.setText(findTestObject('Object Repository/Page_Amazon Sign In/input_password'), 'Govardhan@123')
